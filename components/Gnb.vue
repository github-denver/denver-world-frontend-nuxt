  ...
  <fragment>
    <ul class="list_gnb">
      ...
      <li>
        ...
        <ul class="list_lnb">
          <li>
            <nuxt-link :to="{ name: 'talk', params: { category: 'talk' } }" class="link_lnb">톡톡 한마디</nuxt-link>
          </li>
          <li>
            <nuxt-link :to="{ name: 'gallery', params: { category: 'gallery' } }" class="link_lnb">이미지 게시판</nuxt-link>
          </li>
        </ul>
      </li>
    </ul>
